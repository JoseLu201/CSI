(define (domain ejercicio_1)
	...
	;Usar constantes para representar el tipo de unidad VCE, 
	;los tipos de edificio CentroDeMando y Barracones, y los 
	;tipos de recurso Minerales y Gas.
	(:constants
		VCE - tipoUnidad
	...
	(:predicates
		...
		; Determinar si un edificio o unidad (entidad) está en una localización concreta
		...
		(caminoEntre ?x1 ?x2 - localizacion )
